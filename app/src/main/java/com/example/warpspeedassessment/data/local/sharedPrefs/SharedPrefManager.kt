...
@Singleton
class SharedPrefManager @Inject constructor() : SharedPrefManagerContract {
    ...
    override fun retrieveBooleanFromSharedPrefs(key: String, defaultValue: Boolean): Boolean =
        sharedPrefObject.getBoolean(key, defaultValue)
